    ...
    <div class="rounded-3xl border border-indigo-100 bg-white p-4 shadow-sm ring-1 ring-slate-900/5 sm:p-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div id="bulk-actions" class="hidden flex items-center gap-2">
                    <button id="bulk-restore-btn"
                        class="flex items-center gap-2 px-4 py-2 bg-indigo-50 text-indigo-600 border border-indigo-100 rounded-xl hover:bg-indigo-100 transition-all text-xs font-bold uppercase tracking-wider shadow-sm">
        ...
        <div class="relative">
            <table id="archived-users-table" class="w-full text-left border-collapse"
                ...
                data-bulk-restore-url="{{ route('tenant.admin.users.bulk-restore') }}"
                data-bulk-force-delete-url="{{ route('tenant.admin.users.bulk-force-delete') }}">
                <thead>
                    <tr>
                        <th class="w-10">
