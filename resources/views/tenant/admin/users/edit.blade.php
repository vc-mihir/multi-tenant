            ...
            <form action="{{ route('tenant.admin.users.update', $user->id) }}" method="POST" class="space-y-6">
                ...
                <div class="p-4 rounded-xl bg-amber-50 border border-amber-100 mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-xs font-medium text-amber-800 tracking-wide">Leave password fields blank if you don't
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- Confirm Password --}}
                    <div>
                        <label for="password_confirmation" class="block text-sm font-bold text-slate-700 mb-2">Confirm New
                            Password</label>
                        <div class="relative">
